...

{
	...
	if (_damage < 1) then {
		...
		} forEach (["TentStorage","BuiltItems"]);
...
if (worldName != "namalsk") then {
	[["UH60Wreck_DZ", "UH1Wreck_DZ"], ["Military", "HeliCrash", "MilitarySpecial"], 6, (30 * 60), (15 * 60), 0.89, 'center', 4000, true, false] spawn server_spawnWreck;
} else {
	[["Land_mi8_crashed", "Land_wreck_c130j_ep1", "Misc_cargo_cont_net1"], ["HeliCrashNamalsk", "HospitalNamalsk"], 6, (30 * 60), (15 * 60), 0.89, 'center', 4000, false, false] spawn server_spawnWreck;
};

[["MV22Wreck", "LADAWreck", "BMP2Wreck", "MH60Wreck", "C130JWreck", "Mi24Wreck", "UralWreck", "HMMWVWreck", "T72Wreck"], ["Residential", "Industrial", "Military", "Farm", "Supermarket", "Hospital"], 18, (50 * 60), (15 * 60), 0.75, 'center', 4000, false, false] spawn server_spawnWreck;

if (dayz_plusversionNo != null) then {
	[["UH60Wreck_DZ", "UH1Wreck_DZ"], ["UH60Crash", "UH1YCrash"], 6, (40 * 60), (15 * 60), 0.75, 'center', 4000, true, false] spawn server_spawnWreck;
};

[["Misc_cargo_cont_net1", "Misc_cargo_cont_net2", "Misc_cargo_cont_net3"], ["Residential", "Industrial", "Military", "Farm", "Supermarket", "Hospital"], 6, (40 * 60), (15 * 60), 0.75, 'center', 4000, false, false] spawn server_spawnWreck;